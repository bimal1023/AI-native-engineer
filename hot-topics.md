...
| **Autoregressive decoding & sampling** | [01](01-llm-fundamentals/README.md#16-inference-and-decoding-sampling-params-kv-cache-streaming) | Temperature, top-p, KV cache, TTFT vs. per-token latency — the mechanics are fixed |
| **Training lifecycle** | [01](01-llm-fundamentals/README.md#15-the-training-lifecycle-pretraining--sft--preference-tuning) | Pretrain → SFT → preference-tune. Algorithms change; the shape doesn't |
